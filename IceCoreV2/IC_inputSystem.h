...
private:
	...
	// Which input mode is being used
	// Allows input to be forwarded to only the game, only the UI or both.
...
#pragma region Action mapping functions
	...
	// Consume a key
	void ConsumeKey(KeyboardKey key);
	// Consume a mouse button
